...
def make_space(data, partition=None, window=2, sample=0.0001, ns_exponent=0.7, sg=0, alpha=0.09, negative=10, epochs=5, vector_size=vectorsize):
    ...
    model = word2vec.Word2Vec(window=window, sample=sample, ns_exponent=ns_exponent, sg=sg, alpha=alpha, size=vector_size, negative=negative, iter=epochs)
